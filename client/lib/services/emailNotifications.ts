...
class EmailNotificationService {
  private templates: Record<string, (data: EmailNotificationData) => EmailTemplate> = {
  ...
  private getTemplateKey(notification: Notification): string {
  ...
  private createSecurityAlertTemplate(data: EmailNotificationData): EmailTemplate {
  ...
  private createDeploymentStatusTemplate(data: EmailNotificationData): EmailTemplate {
    const { notification, userPreferences } = data;
  ...
  private createAIRequestCompleteTemplate(data: EmailNotificationData): EmailTemplate {
    const { notification, userPreferences } = data;
  ...
  private createVulnerabilityFoundTemplate(data: EmailNotificationData): EmailTemplate {
    const { notification, userPreferences } = data;
  ...
  private createTeamInvitationTemplate(data: EmailNotificationData): EmailTemplate {
    const { notification, userPreferences } = data;
  ...
  private createBillingAlertTemplate(data: EmailNotificationData): EmailTemplate {
    const { notification, userPreferences } = data;
  ...
  private createSystemMaintenanceTemplate(data: EmailNotificationData): EmailTemplate {
    const { notification, userPreferences } = data;
  ...
  private createWeeklyReportTemplate(data: EmailNotificationData): EmailTemplate {
    const { notification, userPreferences } = data;
