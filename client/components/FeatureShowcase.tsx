  ...
  const features = [
    {
      ...
      description: "Advanced machine learning algorithms that analyze complex data patterns and provide actionable insights in real-time.",
      icon: "🧠",
      benefits: [
    ...
    },
    {
      ...
      description: "Streamline your entire development lifecycle with intelligent automation, from code deployment to infrastructure scaling.",
      icon: "⚙️",
      benefits: [
    ...
    },
    {
      ...
      description: "Proactive threat detection and prevention using AI-powered security algorithms that protect your systems 24/7.",
      icon: "🛡️",
      benefits: [
    ...
    },
    {
      ...
      description: "Comprehensive dashboards with interactive visualizations that turn complex data into simple, actionable insights.",
      icon: "📊",
      benefits: [
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className={`text-center mb-20 transition-all duration-1000 ${
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-torch"> scale your business</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Powerful AI-driven tools and automation that help you build, deploy, and scale your applications with confidence.
          </p>
        </div>
        ...
        <div className={`mb-20 transition-all duration-1000 delay-300 ${
          ...
          <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-2xl border border-gray-100">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              {/* Content */}
              <div>
                <div className={`inline-block px-4 py-2 bg-${features[activeFeature].color}/10 text-${features[activeFeature].color} rounded-full text-sm font-medium mb-6`}>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  {features[activeFeature].benefits.map((benefit, index) => (
                    <div key={index} className="flex items-center space-x-3">
                      <div className={`w-2 h-2 bg-${features[activeFeature].color} rounded-full`}></div>
              ...
              <div className="relative">
                {activeFeature === 0 && features[activeFeature].image ? (
                  ...
                  <div className={`aspect-square bg-gradient-to-br from-${features[activeFeature].color}/10 to-${features[activeFeature].color}/5 rounded-2xl p-8 flex items-center justify-center relative overflow-hidden`}>
                    ...
                    <div className="relative z-10 text-center">
                      <div className={`w-32 h-32 bg-${features[activeFeature].color}/20 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse`}>
                        <span className="text-6xl">{features[activeFeature].icon}</span>
                      </div>
                      <div className={`w-48 h-2 bg-${features[activeFeature].color}/30 rounded-full mx-auto`}>
                        <div className={`h-2 bg-${features[activeFeature].color} rounded-full animate-pulse`} style={{ width: '75%' }}></div>
                      </div>
                    </div>
                  </div>
                )}
