...
export function LiveChatbot() {
  ...
  const generateBotResponse = (userInput: string): ChatMessage => {
    ...
    if (lowerInput.includes("pricing") || lowerInput.includes("cost") || lowerInput.includes("plan")) {
      ...
      responseText = "🔌 FeexSystems integrates seamlessly with 100+ tools including:\n\n• **Development**: GitHub, GitLab, Bitbucket\n• **Cloud**: AWS, Azure, Google Cloud\n• **Monitoring**: Datadog, New Relic, Splunk\n• **Communication**: Slack, Teams, Discord\n\nWe also provide robust APIs and webhooks for custom integrations. Need help with a specific integration?";
      suggestions = ["View all integrations", "API documentation", "Custom integration", "Setup help"];
    } else if (lowerInput.includes("support") || lowerInput.includes("help") || lowerInput.includes("contact")) {
      responseText = "🤝 We're here to help! FeexSystems offers multiple support channels:\n\n📚 **Documentation**: Comprehensive guides and tutorials\n💬 **Live Chat**: 24/7 support (that's me!)\n📧 **Email Support**: technical@feexsystems.com\n📞 **Phone Support**: For Professional and Enterprise plans\n\nWhat specific help do you need?";
      suggestions = ["Technical support", "Billing question", "Report a bug", "Feature request"];
    } else if (lowerInput.includes("security") || lowerInput.includes("safe") || lowerInput.includes("privacy")) {
      responseText = "🔒 Security is our top priority at FeexSystems:\n\n• **SOC 2 Type II** certified\n• **ISO 27001** compliant\n• **End-to-end encryption** for all data\n• **Zero-trust architecture**\n• **Regular security audits**\n• **GDPR & CCPA** compliant\n\nYour data is protected with bank-level security. Want to learn more about our security measures?";
      suggestions = ["Security whitepaper", "Compliance details", "Data privacy", "Audit reports"];
    } else if (lowerInput.includes("free") || lowerInput.includes("trial") || lowerInput.includes("start")) {
      responseText = "🎉 Yes! You can start with FeexSystems completely free:\n\n✅ **14-day free trial** - Full access to all features\n✅ **No credit card required** to start\n✅ **Free onboarding** and setup assistance\n✅ **Cancel anytime** during trial\n\nReady to transform your business with AI? I can help you get started right now!";
      suggestions = ["Start free trial", "Setup assistance", "Onboarding guide", "Pricing details"];
    } else {
      responseText = "🤔 That's a great question! I'd be happy to help you learn more about FeexSystems. Our AI-powered platform helps businesses automate their workflows, enhance security, and gain valuable insights from their data.\n\nI can provide information about our features, pricing, demos, or connect you with our team. What would you like to explore?";
