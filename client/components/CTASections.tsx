      ...
      <section className="py-24 bg-gradient-to-br from-torch-dark via-gray-900 to-torch-dark text-white overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-torch"> business with AI?</span>
          </h2>
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Join thousands of companies already using FeexSystems to automate workflows, 
            enhance security, and drive growth. Start your free trial today.
          </p>
      ...
      <section className="py-16 bg-gradient-to-r from-torch-orange to-torch-yellow">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-white/90 mb-8">
            Get weekly insights on AI trends, product updates, and exclusive content from our experts.
          </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Book a personalized demo with our team and discover how FeexSystems 
                  can transform your specific use case.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                icon: "💬",
                title: "Community",
                description: "Connect with developers, share ideas, and get help",
              ...
              >
                ...
                <button className={`w-full py-3 px-6 bg-${resource.color}/10 text-${resource.color} font-semibold rounded-lg hover:bg-${resource.color}/20 transition-colors`}>
                  {resource.action}
                </button>
              </div>
            ))}
