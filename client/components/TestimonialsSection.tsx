  ...
  const testimonials = [
    {
      ...
      avatar: "👩‍💼",
      rating: 5,
      quote: "FeexSystems transformed our entire development workflow. We've seen a 40% increase in deployment efficiency and our security posture has never been stronger.",
      metrics: {
        improvement: "+40%",
    ...
    },
    {
      ...
      avatar: "👨‍💻",
      rating: 5,
      quote: "The AI-powered insights have been game-changing. We can predict and prevent issues before they impact our customers. The ROI has been incredible.",
      metrics: {
        improvement: "99.9%",
    ...
    },
    {
      ...
      avatar: "👩‍🔬",
      rating: 5,
      quote: "Integration was seamless and the learning curve was minimal. Our team was productive from day one. The support team is exceptional.",
      metrics: {
        improvement: "75%",
    ...
    },
    {
      ...
      avatar: "👨‍🔒",
      rating: 5,
      quote: "Security compliance used to take weeks. Now it's automated and we pass audits with confidence. FeexSystems is essential to our operations.",
      metrics: {
        improvement: "-85%",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className={`text-center mb-20 transition-all duration-1000 ${
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
            Trusted by industry
            <span className="text-transparent bg-clip-text bg-gradient-torch"> leaders worldwide</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Join thousands of companies that have transformed their operations with FeexSystems.
          </p>
        </div>
