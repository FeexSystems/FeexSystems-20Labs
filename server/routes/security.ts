...
router.get('/stats', async (req, res) => {
  try {
    ...
    const stats = await securityService.getUserStats(userId, period as any);
...
router.get('/dashboard', async (req, res) => {
  try {
    ...
    const dashboardData = await vulnerabilityReportingService.getDashboardData(userId, timeframe as any);
...
router.get('/vulnerability-trends', async (req, res) => {
  try {
    ...
    const trends = await vulnerabilityReportingService.getVulnerabilityTrends(userId, period as any);
...
router.get('/remediation/metrics', async (req, res) => {
  try {
    ...
    const metrics = await vulnerabilityRemediationService.getRemediationMetrics(userId, timeframe as any);
