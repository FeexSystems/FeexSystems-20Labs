...
router.get('/stats', async (req, res) => {
  try {
    ...
    const stats = await aiService.getUserStats(userId, period as any);
...
router.get('/analytics/usage', async (req, res) => {
  try {
    ...
    const metrics = await aiAnalyticsService.getUserUsageMetrics(userId, period as any);
...
router.get('/analytics/cost', async (req, res) => {
  try {
    ...
    const analysis = await aiAnalyticsService.getCostAnalysis(userId, period as any);
...
router.get('/analytics/performance', async (req, res) => {
  try {
    ...
    const metrics = await aiAnalyticsService.getPerformanceMetrics(userId, period as any);
...
router.get('/admin/analytics/system', async (req, res) => {
  try {
    ...
    const analytics = await aiAnalyticsService.getSystemAnalytics(period as any);
