import { AIService, AIServiceConfig, AIProviderConfig } from '../types/ai';
...
export class AIServiceRegistry {
   ...
   */
  getServicesByCategory(category: string): AIService[] {
   ...
   */
  updateService(serviceId: string, updates: Partial<AIService>): boolean {
   ...
   */
  registerProvider(providerId: string, config: AIProviderConfig): void {
   ...
   */
  getProviders(): Record<string, AIProviderConfig> {
   ...
   */
  loadConfiguration(config: AIServiceConfig): void {
    // Clear existing
    this.services.clear();
   ...
   */
  exportConfiguration(): AIServiceConfig {
    return {
   ...
   */
  validateService(service: AIService): string[] {
    const errors: string[] = [];
