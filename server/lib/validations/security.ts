 ...
 */
export function validateScanTarget(target: any): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 */
export function validateScanConfiguration(config: any): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 */
export function sanitizeScanConfiguration(config: any): any {
  ...
  if (sanitized.excludePatterns) {
    sanitized.excludePatterns = sanitized.excludePatterns
      .filter((pattern: string) => typeof pattern === 'string')
 ...
 */
export function validateRequestSize(data: any, maxSize: number = 1024 * 1024): boolean {
