 ...
 */
export const auditAdminAction = (action: string, resourceType: string) => {
 ...
 */
function generateAdminSessionId(): string {
 ...
 */
export const protectAdminRoute = (permission: keyof AdminPermissions, action?: string, resourceType?: string) => {
  const middleware = [
 ...
 */
export const protectSuperAdminRoute = (action?: string, resourceType?: string) => {
  const middleware = [
    ...adminMiddlewareStack,
    requireSuperAdmin
  ];
